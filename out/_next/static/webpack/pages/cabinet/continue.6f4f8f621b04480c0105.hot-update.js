...
var _onSubmit = function onSubmit(values) {
  if (iban.text !== 'Заполните поле до конца' || iban.text !== 'Некорректный счет') {
    console.log('works');
  }
};
