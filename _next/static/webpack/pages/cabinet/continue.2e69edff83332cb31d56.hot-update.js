...
var ibanContinue = function ibanContinue(val) {
  ...
  if (isValidIBANNumberContinue(val) === 'Некорректный счет' || isValidIBANNumberContinue(val) === 'Заполните поле до конца') {
